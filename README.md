...
![](img/main.png "Abbildung: https://selbstgesteuertes-lernen.de")
...
![Logo: HDS](img/logo-hds.png)<!--style="height: 60px; background-color: white; margin: 10px"-->

![Logo: Bildungsportal Sachsen](img/logo-bildungsportal-sachsen.png)<!--style="height: 60px; background-color: white; margin: 10px"-->

<!--style="max-width: 400px"-->
![Logo: Sachsen](img/logo-sachsen.png)<!--style="height: 60px; background-color: white; margin: 10px"-->
...
![CC-By-SA](img/cc-by-sa.png)<!-- style="margin-top: 30px; height: 60px" -->
...
![Kursstruktur](img/organisation.png "_Abbildung 1 : Kursstruktur und -bausteine im LMS Kurs_")
...
Neben einer Hauptmoderation ist die Übernahme folgender Aufgaben durch eine Co-Moderation ratsam:
...
![Meeresschildkröte](https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Shell_Games_%288375933995%29.jpg/960px-Shell_Games_%288375933995%29.jpg "[LASILO ILYES, [Shell Games](https://commons.wikimedia.org/wiki/File:Shell_Games_%288375933995%29.jpg) [CC BY 2.0](https://creativecommons.org/licenses/by/2.0)]")
...
![Landschildkröte](img/turtle-2.jpg "[Tambako The Jaguar, [Big turtle in water](https://www.flickr.com/photos/tambako/9770515335), [CC BY-ND 2.0](https://creativecommons.org/licenses/by-nd/2.0)]")
...
![Logo: HDS](img/logo-hds.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Bildungsportal Sachsen](img/logo-bildungsportal-sachsen.png)<!--style="height: 80px; background-color: white; margin: 20px"-->
</div>

Gefördert durch den Freistaat Sachsen

![Logo: SächsischesStaatsministerium für Wissenschaft un Kunst](img/logo-staatsministerium-wissenschaft-kunst.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

Unter Beteiligung der sächsischen Universitäten und Hochschulen für angewandte Wissenschaften

<div style="display: flex; flex-wrap: wrap; align-items: center; gap: 20px;">

![Logo: Hochschule Zittau/Görlitz](img/logo-hochschule-zittau.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Technische Universität Chemnitz](img/logo-tu-chemnitz.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Westsächsische Hochschule Zwickau](img/logo-whz-zwickau.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Hochschule für Technik, Wirtschaft und Kultur Leipzig](img/logo-htwk.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Technische Universität Chemnitz](img/logo-tu-chemnitz.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Hochschule für Technik und Wirtschaft Dresden](img/logo-htwd.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Technische Universität Bergakademie Freiberg](img/logo-tubaf.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Universität Leipzig](img/logo-uni-leipzig.png)<!--style="height: 80px; background-color: white; margin: 20px"-->

![Logo: Hochschule Mittweida](img/logo-hs-mittweida.png)<!--style="height: 80px; background-color: white; margin: 20px"-->
